...
// class definition for binaty search tree
class bst{
 public:
	int strange;
	bst* r_child;
...
// function to insert element in the bst
void insertit(int n) {
	bst* elem = new bst();
	elem->strange = n;
	elem->l_child = NULL;
...
// function to print elements of bst in preorder traversal
void preorderTr(bst* lal) {
	bst* hell = lal;
	if(hell!=NULL) {
		ouf << hell->strange << " ";
...
// function to prinat elements of bst in postorder traversal
void postorderTr(bst* lal) {
	bst* hell = lal;
	if(hell!=NULL) {
...
// function to return minimum value of bst
int mini() {
	bst* min = root;
...
// function to return maximum value of bst
int maxi() {
	bst* max = root;
...
// function to search pointer of passed element
...
// function to find successor of passed element
...
// function to find predecessor of passed element
class bst* predecessor(bst* deserve,int n) {
...
// function to delete passed element
